    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(ViewUploadsActivity.this, " Downloading the File , please check Your Download's ", Toast.LENGTH_LONG).show();
                ...
                if(applictionFile != null && applictionFile.exists())
                {
                    ...
                    Toast.makeText(ViewUploadsActivity.this, "This file Already downloaded ", Toast.LENGTH_SHORT).show();
