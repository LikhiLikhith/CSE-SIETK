...
public class ViewThreetwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_threetwo);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(ViewThreetwo.this, " Downloading the File , please check Your Download's ", Toast.LENGTH_LONG).show();
                ...
                if(applictionFile != null && applictionFile.exists())
                {
                    ...
                    Toast.makeText(ViewThreetwo.this, "This file Already downloaded ", Toast.LENGTH_SHORT).show();

                }
                else
                {

                    downloadFile(ViewThreetwo.this,uploadList.get(i).getName(),
