...
public class ViewOneone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_oneone);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(ViewOneone.this, " Downloading the File , please check Your Download's ", Toast.LENGTH_LONG).show();
                ...
                if(applictionFile != null && applictionFile.exists())
                {
                    ...
                    Toast.makeText(ViewOneone.this, "This file Already downloaded ", Toast.LENGTH_SHORT).show();

                }
                else
                {

                    downloadFile(ViewOneone.this,uploadList.get(i).getName(),
